...
<title><c:out value="${Constant.webName}"/> - Dealer Home</title>
...
<div class="jumbotron jumbotron-fluid mb-0" style="background-image: url('images/placeholder/dealership_banner.jpg'); background-repeat: no-repeat; background-size: cover;">
  ...
  <h1 class="display-4">Welcome <c:out value="${dealer.getFirstName()}"/></h1>
...
<div class="col-md-1"></div>
	<div class="col bg-secondary shadow-lg rounded-lg text-light p-2">
		...
		<a href="dealer_manage_vehicles.jsp"><img class="w-100 rounded-lg img-responsive" src="images/placeholder/dealer_inventory.jpg" alt=""></a>
	</div>
	<div class="col">
	<h4>Add a Vehicle</h4>
		<a href="dealer_add_vehicle.jsp"><img class="w-100 rounded-lg img-responsive" src="images/placeholder/dealer_add.png" alt=""></a>
	</div>
	<div class="col bg-secondary shadow-lg rounded-lg text-light p-2">
	<h4>Analysis and History</h4>
		<a href="dealer_view_history.jsp"><img class="w-100 rounded-lg img-responsive" src="images/placeholder/dealer_history.png" alt=""></a>
	</div>
	<div class="col-md-1"></div>
</div>
